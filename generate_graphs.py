...
def generate_confusion_matrix():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figure2.png'), dpi=300, transparent=True)
    plt.close()
...
def generate_accuracy_loss():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figure3.png'), dpi=300, transparent=True)
    plt.close()
...
def generate_atsad_metrics():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figure4.png'), dpi=300, transparent=True)
    plt.close()
...
def generate_space_weather_correlation():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figure5.png'), dpi=300, transparent=True)
    plt.close()
